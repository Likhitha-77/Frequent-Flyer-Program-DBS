...
public class MainActivity3 extends AppCompatActivity {
    ...
    @SuppressLint({"MissingId", "MissingInflatedId"})
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url="http://10.0.2.2:8080/frequentflier/flights.jsp?flightid="+fid;
    ...
    public void initTable(String[] result) {
        ...
        for (int itr =0; itr< result.length; itr++){
            ...
            String  flightid= row[0];
            String flightmiles = row[1];


            String destination = row[2];
            TableRow tableRow = new TableRow(this);
            TextView trefView = new TextView(this);
            trefView.setText(" " + flightid);
            tableRow.addView(trefView);

            TextView dateView = new TextView(this);
            dateView.setText(" " + flightmiles);
